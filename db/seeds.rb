...
Itinerary.create!(name: 'Saint-Malo, la cité corsaire', distance: 5, rating: 5, duration: 120, number_of_poi: 3, departure: 'Porte Saint-vincent 35400 Saint-Malo', city_id: City.last.id)
Itinerary.create!(name: 'Les secrets du Mont-Saint-Michel', distance: 7, rating: 5, duration: 160, number_of_poi: 4, departure: 'Pont Passerelle du Mont Saint-Michel, 50170 le Mont Saint Michel', city_id: City.last.id)
Itinerary.create!(name: 'Dinan et ses remparts', distance: 10, rating: 5, duration: 180, number_of_poi: 6, departure: 'Le Vieux Pont 22100 Dinan', city_id: City.last.id)
...
Trip.create!(proximity_level: 0, content: 'blabla', status: 'running', progress: 'image', user_id: User.last.id, itinerary_id: Itinerary.last.id)
puts "created #{Trip.count} trips"

puts '####### Creating Questions #############'

Question.create!(question_statement: 'Quel etait le surnom de la ville de Saint-Malo ? la cité ... :', itinerary_id: Itinerary.last.id)
