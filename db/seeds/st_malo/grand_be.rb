...
grandbe_itinerary_pictures = [File.open("db/seeds/st_malo/images/GrandBe1.jpg")]
grandbe_itinerary = Itinerary.new(name: 'La tombe de fameux Chateaubriand', subtitle: "Une promenade entre mer et histoire",
